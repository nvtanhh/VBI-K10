...
let Contract = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = view(), _dec4 = view(), _dec5 = view(), _dec6 = view(), _dec7 = view(), _dec8 = call({}), _dec(_class = (_class2 = class Contract {
  constructor() {
    this.token_id = 0;
    this.owner_id = '';
  ...
  mint_nft({
    ...
    let token = new MyNFT(this.token_id, token_owner_id, metadata);
    this.token_by_id.set(this.token_id.toString(), token);
    this.token_id++;
    return token;
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_total_supply", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_total_supply"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_all_tokens", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_all_tokens"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_token_by_id", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "get_token_by_id"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "nft_supply_for_owner", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "nft_supply_for_owner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_tokens_for_owner", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "get_tokens_for_owner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "mint_nft", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "mint_nft"), _class2.prototype)), _class2)) || _class);
function mint_nft() {
...
function get_tokens_for_owner() {
  ...
  const _args = Contract._getArgs();
  const _result = _contract.get_tokens_for_owner(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Contract._serialize(_result, true));
}
...
export { MyNFT, get_all_tokens, get_token_by_id, get_tokens_for_owner, init, mint_nft, nft_supply_for_owner, nft_total_supply };
